...
import com.nikitahohulia.listeningplatform.user.infrastructure.adapter.nats.subscriber.UserUpdatedNatsEventServiceOutPort
...
class GrpcUserService(
    ...
    private val userUpdatedEventService: UserUpdatedNatsEventServiceOutPort
